...
"15379d58bff043f48624ffca1e6cd90f.html",
...
"c26a9d7a299848289fa8e701879fbb9b.html",
...
"Add Objects from a Spreadsheet",
"Manage Users",
"Participants Page",
...
"Object Page",
"List Report",
"Using Smart Templates to Create a List Report and Object Pages",
...
"Modifying Data Under the Samples Tab",
...
"Using Sample Files to Create a Data Model",
...
"View the Page Map from th UI Editor to see a map view for your project. Page thumbnails and navigation are also represented in the Page Map.",
...
"The List Report is usually the first page of apps designed for finding a few, dedicated objects from a large set of objects. The List Report contains a filter bar above a table.",
...
"You have generated a data model from an Excel file and now you would like to add an object manually.",
"The User Interface Editor includes various tools to enable you to create beautiful and interactive mockups for your app.",
"When adding objects or importing via Excel you need to respect the following rules in order for the import process to succeed.",
...
"Use the UI library Controls in the UI Editor to make prorotypes interactive. Drag and drop controls to the canvas, and apply properties and actions to customize their function",
...
"BUILD includes the User Interface (UI) Editor, which enables you to easily and quickly create beautiful prototypes, wireframes, and interactive click-through mockups for your application.",
"When you have finished configuring your List Report, you are ready to configure one or more object pages.",
...
"In BUILD, you can create and modify data models in your projects, allowing you to manage meaningful business data.",
...
"After you have added objects to a data model you need to create relations between various objects.",
...
"You begin creating a data model once you have created a project. This section describes how to manually create a data model by adding objects.",
"The Edit mode lets you change the properties of objects in an object page.",
"This table summarizes how properties are displayed in the property pane:",
...
"You can modify a relation from the Relations tab in the side pane to the right of the canvas.",
...
"",
"You can manually add data to an object in your data model.",
...
"Once you have created or imported a data model you can start using the smart templates.",
