...
"",
"As a BUILD Administrator, you need to follow these initial steps before users can use the system.",
...
"You can invite additional participants at any time on the Participant Invitation page. To view this page, select the study tile on the Research page, and select the Participant Inviation tab.",
...
"You can view the responses to and statistics about questions in studies by selecting the thumbnail image for questions on the Tasks and Questions page. The Page Overview tab is displayed by default. You can select the Statistics tab to display statistics about the question.",
...
"",
"You can create a team for your project by inviting colleagues to collaborate as project team members. The member of a project team are displayed in the Project Team section of the Project page. The owner has the crown! You can also be invited to become a team member of other BUILD users  projects.",
...
"To add a task to a study you upload an interactive prototype, select Start and Target pages, and enter user guidance. Study participants will interact with the prototype and, based on the user guidance, select the I HAVE FINISHED THIS TASK button when they have displayed the Target page. ",
...
"The Statistics tab of the participants responses to a task displays overall statistics about a task, and information about participants who attempted to complete the task. You can export the question data by selecting the Export Question Data link on this page.",
"The BUILD user research module enables you to quickly create and share user research studies to gather sophisticated feedback from colleagues or end-users about images, project pages, or interactive HTML prototype applications.",
...
"",
"You can display participants  responses to a task in a study by selecting the thumbnail of the task on the Tasks and Questions tab on the results page of your study.",
...
"As project owner you can display a picture on the project tile. Adding a unique picture to each of your project tiles makes it easier to identify the project at a glance.",
"The Tasks and Questions tab on the result page of active or archived studies provides high-level statistics about participants  responses to each task and question in the study. You can view the actual responses to and detailed statistics about each task and question by selecting the thumbnail images.",
