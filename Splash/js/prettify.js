...
// BESTL-7477: ABAP Syntax Highlighting (Prettify)	  
  var ABAP_KEYWORDS = [FLOW_CONTROL_KEYWORDS, 'ABAP-SOURCE ABBREVIATED ABSTRACT ACCEPT ACCEPTING' +  
  ...
  function sourceDecorator(options) {
	...
	//PR_ATTRIB_NAME
   //BESTL-9279:Codeblock Syntax Highlighting (Prettify) correct colour coding for PERL variables
   if (options['attribName']) {
      fallthroughStylePatterns.push([PR_ATTRIB_NAME, /(?:&amp;|[$%*]|\$#)\$?[a-zA-Z_](\w+|::)*/, null]);
      fallthroughStylePatterns.push(
         [PR_ATTRIB_NAME, /(?:&amp;|[$%*]|\$#)\$?[a-zA-Z_](\w+|::)*/, null]);
    }
 ...
 // BESTL-7477: ABAP Syntax Highlighting (Prettify)
 // remove these lines to add more details see"Correction on json prettifier".
 /* registerLangHandler(sourceDecorator({
...
// BESTL-7477: ABAP Syntax Highlighting (Prettify)
		registerLangHandler(sourceDecorator({
          'keywords': ABAP_KEYWORDS,
		  'hashComments': true,
          'cStyleComments': true,
          'multilineStrings': true
        }), ['abap']);
	
// BESTL-9279 :Codeblock Syntax Highlighting (Prettify)- prettifier for properties file 
  registerLangHandler(
      createSimpleLexer(
        [
         // Whitespace
        ...
        [
		//hashcommand uses colour light green
		[PR_STRING, /^#(?:##(?:[^#]|#(?!##))*(?:###|$)|.*)/, null, '#'],       
         // An identifier
         [PR_PLAIN, /^[a-z_][\w-]*/i],
         // use colour red for "=" and ":"
		[PR_COMMENT,  /=|:+/]	
        ]),
      ['prefs']);  
// BESTL-7477: ABAP Syntax Highlighting (Prettify)
// Correction on json prettifier
  registerLangHandler(
      createSimpleLexer(
        [
         // Whitespace
        ...
        [
         [PR_COMMENT, /"(\\[\s\S]|[^"])*"|'(\\[\s\S]|[^'])*'|(\/\/.*|\/\*[\s\S]*?\*\/)/],
		 [PR_KEYWORD, /\b(true|false|null)\b/, null],
      ...
      createSimpleLexer(
        ...
        [
         ...
         [PR_COMMENT, /^(?:--[^\r\n]*|\/\*[\s\S]*?(?:\*\/|$))/],
         [PR_KEYWORD, /^(?:ADD|AFTER|ALL|ALTER|AND|ANY|APPLY|AS|ASC|AUTHORIZATION|BACKUP|BEGIN|BETWEEN|BREAK|BROWSE|BULK|BY|CASCADE|CASE|CHECK|CHECKPOINT|CLOSE|CLUSTERED|COALESCE|COLLATE|COLUMN|COLUMNS|COMMIT|COMPUTE|CONNECT|CONSTRAINT|CONTAINS|CONTAINSTABLE|CONTINUE|CONVERT|CREATE|CROSS|CURRENT|CURRENT_DATE|CURRENT_TIME|CURRENT_TIMESTAMP|CURRENT_USER|CURSOR|DATABASE|DBCC|DEALLOCATE|DECLARE|DEFAULT|DELETE|DENY|DESC|DISK|DISTINCT|DISTRIBUTED|DOUBLE|DROP|DUMMY|DUMP|EACH|ELSE|END|ERRLVL|ESCAPE|EXCEPT|EXEC|EXECUTE|EXISTS|EXIT|FETCH|FILE|FILLFACTOR|FOLLOWING|FOR|FOREIGN|FREETEXT|FREETEXTTABLE|FROM|FULL|FUNCTION|GOTO|GRANT|GROUP|HAVING|HOLDLOCK|IDENTITY|IDENTITYCOL|IDENTITY_INSERT|IF|IN|INDEX|INNER|INSERT|INTERSECT|INTO|IS|JOIN|KEY|KILL|LEFT|LIKE|LINENO|LOAD|MATCH|MATCHED|MERGE|NATURAL|NATIONAL|NOCHECK|NONCLUSTERED|NOCYCLE|NOT|NULL|NULLIF|OF|OFF|OFFSETS|ON|OPEN|OPENDATASOURCE|OPENQUERY|OPENROWSET|OPENXML|OPTION|OR|ORDER|OUTER|OVER|PARTITION|PERCENT|PIVOT|PLAN|PRECEDING|PRECISION|PRIMARY|PRINT|PROC|PROCEDURE|PUBLIC|RAISERROR|READ|READTEXT|RECONFIGURE|REFERENCES|REPLICATION|RESTORE|RESTRICT|RETURN|REVOKE|RIGHT|ROLLBACK|ROWCOUNT|ROWGUIDCOL|ROWS?|RULE|SAVE|SCHEMA|SELECT|SESSION_USER|SET|SETUSER|SHUTDOWN|SOME|START|STATISTICS|SYSTEM_USER|TABLE|TEXTSIZE|THEN|TO|TOP|TRAN|TRANSACTION|TRIGGER|TRUNCATE|TSEQUAL|UNBOUNDED|UNION|UNIQUE|UNPIVOT|UPDATE|UPDATETEXT|USE|USER|USING|VALUES|VARYING|VIEW|WAITFOR|WHEN|WHERE|WHILE|WITH|WITHIN|WRITETEXT|XML)(?=[^\w-]|$)/i, null],
        // A number is a hex integer literal, a decimal real literal, or in
         // scientific notation.
         [PR_LITERAL,
          /^[+-]?(?:0x[\da-f]+|(?:(?:\.\d+|\d+(?:\.\d*)?)(?:e[+\-]?\d+)?))/i],
    ...
    createSimpleLexer([], 
     ...
     ['css-str']); 
//End of BESTL-7477: ABAP Syntax Highlighting (Prettify)
  registerLangHandler(
